<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>tbl school
        ...
        <div class="col-md-12">
            <livewire:table.school-extracurricular-table params="{{request()->route()->getName()}}" />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} tbl school extracurriculars</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="extracurricular_name" label="Extracurricular name" />
                    </div>
