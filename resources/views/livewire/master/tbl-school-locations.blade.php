<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>school locations</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.school-location-table />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} school locations</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="school_location_name" label="Location Name" />
                        <x-input-photo foto="{{$school_location_image}}"
                            path="{{optional($school_location_image_path)->temporaryUrl()}}"
                            name="school_location_image_path" label="Location Image" />
                    </div>
