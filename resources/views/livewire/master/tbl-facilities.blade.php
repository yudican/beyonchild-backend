                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} facilities</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="facility_name" label="Facility Name" />
                        <x-input-photo foto="{{$facility_icon}}"
                            path="{{optional($facility_icon_path)->temporaryUrl()}}" name="facility_icon_path"
                            label="Facility Icon" />
                    </div>
