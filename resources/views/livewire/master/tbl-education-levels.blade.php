<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>education levels</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.education-level-table />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} education levels</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="education_level_name" label="Level Name" />
                        <x-input-photo foto="{{$education_level_image}}"
                            path="{{optional($education_level_image_path)->temporaryUrl()}}"
                            name="education_level_image_path" label="Image" />
                    </div>
