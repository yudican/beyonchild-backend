<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>event categories</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.event-category-table />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} event categories</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="event_category_name" label="Category name" />
                        <x-select name="event_category_type" label="Category type">
                            <option value="">Select Category type</option>
                            <option value="member">Member</option>
                            <option value="regular">Regular</option>
                        </x-select>
                        <x-select name="event_is_paid" label="Is paid">
                            <option value="">Select Is paid</option>
                            <option value="1">Paid</option>
                            <option value="0">Free</option>
                        </x-select>
                        @if ($event_is_paid == 1)
                        <x-text-field type="number" name="event_discount" label="Discount (%)" />
                        @endif
                    </div>
