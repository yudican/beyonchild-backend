<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            <livewire:table.intelligence-question-table />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} intelligence questions</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="question_name" label="name" />
                        <x-text-field type="number" name="question_score" label="score" />
                        {{-- <x-select name="smart_category_id" label="Category">
